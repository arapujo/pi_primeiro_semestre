	...
	<div class="curso-mobile">
		<div class="card" >
			<div class="card-body">
			 ...
			 <div class="img-mobile"><img  src="../../assets/img/portugues.jpg"></div
			  <p class="card-text">Aprenda concordância nominal e verbal, o que são substantivos e adjetivos e pontuação.</p>
			...
			<div class="card-body">
				...
				<p class="card-text">
					- Exclamação, vírgula, ponto final, travessão, ponto-e-vírgula e dois pontos.<br>
					- Adjetivos, pronomes, substantivos e verbos <br>
					- Oração<br>
				</p>
