	...
	<div class="curso-mobile">
		<div class="card" >
			<div class="card-body">
			 ...
			 <div class="img-mobile"><img  src="../../assets/img/ingles.jpg"></div
			  <p class="card-text">Aprenda os tempos verbais, vocabulário, como se aprensentar e conversação.</p>
			...
			<div class="card-body">
				...
				<p class="card-text">
					- Palavras mais utilizadas <br>
					- Técnicas de conversação<br>
					- Present simple<br>
					- Past simple<br>
