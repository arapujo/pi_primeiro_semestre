	...
	<div class="curso-mobile">
		<div class="card" >
			<div class="card-body">
			 ...
			 <div class="img-mobile"><img  src="../../assets/img/hardware.jpg"></div
			  <p class="card-text">Aprenda a fazer manutenções, reparos e diagnósticos, como manusear de forma correta os componentes, protocolos de seguranças, como funciona redes de computadores e boas práticas.</p>
			...
			<div class="card-body">
				...
				<p class="card-text">
					A matéria de Hardware visa apresentar e discutir conceitos sobre a parte externa de um sistema computacional (computador), a origem do seu termo, rede de computadores e a montagem de computadores.
